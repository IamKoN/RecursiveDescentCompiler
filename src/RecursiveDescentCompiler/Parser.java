...
//Stack Operation Methods
    ...
    public int Rvalue() {
        Match(TokenType.RVALUE);
        return 0;
    }
    public int Lvalue() {
        Match(TokenType.LVALUE);
        return 0;
    }
    public int Copy() {
        Match(TokenType.COPY);
        return 0;
    }
    public int Sto() {
        Match(TokenType.STO);
 ...
 */
    ...
    public static void main(String args[]) throws IOException { 
        ...
        /* Uncomment next three line to enter your own 'expression' file.
        Make sure to change "ct1.txt" to inFile */
        //Scanner sc = new Scanner(System.in);
        //System.out.print("Enter file name to open: ");
 	//String inFile = sc.nextLine();
        
        FileInputStream fstream = new FileInputStream("ct1.txt");
